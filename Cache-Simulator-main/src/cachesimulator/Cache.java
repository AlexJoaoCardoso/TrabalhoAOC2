...
public class Cache {
    ...
    public void resultado() {//Printa o resultado de acordo com a flag de saida: 0 ou 1
        ...
        if (this.flagSaida == 1) {
            ...
            System.out.println(this.hit/this.totalAcessos + " " + missesTotal/this.totalAcessos + " " + this.missCompulsorio/missesTotal + " " + this.missCapacidade/missesTotal + " " + this.missConflito/missesTotal);
        }else{
